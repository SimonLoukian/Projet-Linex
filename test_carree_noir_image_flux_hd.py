...
COULEUR_NOIR = (0,0,0)
FLUX_RTSP = "rtsp://ProjetLinex:Grum3s2P!n@linex-cam.bts-sn.lrq:1554/live/ch0" #IP Camera
...
def lecture_plaque():
    ...
    modification = cv2.rectangle(image,(1800,0), (2304,100), COULEUR_NOIR, thickness = -1)
